...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-purple-100 text-purple-900 overflow-x-hidden">
      {showSplash && (
      ...
      <div className={`transition-opacity duration-1000 ${homeVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        ...
        <section className="w-full min-h-[520px] flex flex-col lg:flex-row items-center justify-center px-3 sm:px-4 md:px-8 lg:px-28 py-10 sm:py-16 md:py-20 relative overflow-hidden bg-gradient-to-br from-white via-purple-50 to-purple-100 shadow-inner gap-10 md:gap-0">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-center z-10 w-full">
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-100 px-4 sm:px-8 md:px-10 py-8 sm:py-10 max-w-2xl w-full flex flex-col items-center">
              <span className="inline-block px-4 sm:px-5 py-1 rounded-full bg-blue-100/70 border border-blue-300 text-purple-700 font-semibold text-sm sm:text-base mb-4 sm:mb-5 shadow text-center tracking-wide">
                Warm Welcome
              </span>
              ...
              <span className="block text-base sm:text-lg font-light tracking-normal text-purple-700/80 mb-2 text-center">(T&C Apply*)</span>
              <div className="w-12 sm:w-16 h-1 bg-gradient-to-r from-blue-400 to-sky-300 rounded mb-5 sm:mb-7 mx-auto" />
              <p className="mb-4 sm:mb-5 text-base sm:text-lg md:text-xl text-purple-800 font-medium text-center">
                We create <span className="text-purple-600 font-bold">personalized travel plans</span> just for you — designed around your budget, style & dreams.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-5 sm:mb-6 text-purple-800 text-sm sm:text-base font-medium w-full">
              ...
              <p className="mb-5 sm:mb-7 text-purple-900 text-center text-sm sm:text-base">
                Pick <span className="text-purple-600 font-semibold">any 3 services</span>, and you'll receive a
                <span className="text-purple-700 font-extrabold underline ml-1">FREE</span> expertly crafted travel plan — no hidden fees, no surprises.<br />
                <span className="text-xs text-purple-400 italic">Available for a limited time.</span>
              </p>
              <div className="flex flex-col items-center justify-center gap-3 sm:gap-5 w-full mt-4 sm:mt-6">
                ...
                <a
                  href="/contact"
                  className="inline-block px-6 sm:px-10 py-3 sm:py-4 font-semibold rounded-2xl border-2 border-blue-300 bg-gradient-to-r from-blue-200/70 to-sky-100/70 text-purple-900 shadow-xl text-base sm:text-lg hover:scale-105 hover:bg-blue-200/80 hover:text-purple-800 transition mt-2"
                >
        ...
        <section className="relative py-10 sm:py-16 md:py-20 bg-gradient-to-tr from-white via-purple-50 to-purple-100 px-3 sm:px-4 md:px-8 text-center overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 max-w-6xl mx-auto relative z-10">
            <div className="group bg-white/95 rounded-2xl shadow-xl border border-blue-100 px-5 sm:px-7 py-7 sm:py-10 flex flex-col items-center justify-center min-h-[120px] sm:min-h-[170px] transition transform hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-blue-200 cursor-pointer">
              <div className="text-lg sm:text-2xl font-bold text-purple-800 mb-1">Tailor-Made Plans</div>
              <div className="text-purple-700 text-base sm:text-lg">We offer tailor-made travel plans matching your budget.</div>
            </div>
            <div className="group bg-white/95 rounded-2xl shadow-xl border border-blue-100 px-5 sm:px-7 py-7 sm:py-10 flex flex-col items-center justify-center min-h-[120px] sm:min-h-[170px] transition transform hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-blue-200 cursor-pointer">
              <div className="text-lg sm:text-2xl font-bold text-purple-800 mb-1">We Organize</div>
              <div className="text-purple-700 text-base sm:text-lg">
                Stay, Food, Transportation, Rentals — you choose, we organize.
              </div>
            </div>
            <div className="group bg-white/95 rounded-2xl shadow-xl border border-blue-100 px-5 sm:px-7 py-7 sm:py-10 flex flex-col items-center justify-center min-h-[120px] sm:min-h-[170px] transition transform hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-blue-200 cursor-pointer">
              <div className="text-lg sm:text-2xl font-bold text-purple-800 mb-1">FREE Travel Itinerary</div>
              <div className="text-purple-700 text-base sm:text-lg">
                FREE customized travel itinerary with any 3 services you select.
              </div>
            </div>
            <div className="group bg-white/95 rounded-2xl shadow-xl border border-blue-100 px-5 sm:px-7 py-7 sm:py-10 flex flex-col items-center justify-center min-h-[120px] sm:min-h-[170px] transition transform hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-blue-200 cursor-pointer">
              <div className="text-lg sm:text-2xl font-bold text-purple-800 mb-1">Reward Program</div>
              <div className="text-purple-700 text-base sm:text-lg">
                Complete 4 trips, get <span className="text-purple-500 font-bold">50% OFF</span> your 5th trip!
                <p className="text-xs mt-2 text-purple-400">(T&C Apply*)</p>
              </div>
            </div>
          </div>
        </section>

        <section className="py-10 sm:py-16 px-3 sm:px-4 md:px-8 text-center bg-gradient-to-r from-purple-400 via-purple-200 to-purple-400 text-purple-900 rounded-t-3xl mt-10 sm:mt-20 shadow-md">
          ...
          <a
            href="/contact"
            className="inline-block px-6 sm:px-10 py-3 sm:py-4 bg-white text-purple-700 font-bold rounded-xl shadow-md hover:bg-blue-50 transition text-base sm:text-lg"
          >
            Contact Us Now
          </a>
        </section>
